		...
		<div class="nds-hr-form-layout">
			...
			<div class="nds-hr-form-main">
				...
				<div class="nds-hr-card nds-hr-form-section">
					...
					<?php
					// Active Custom Fields (Phase 2C-1: seamlessly integrated into form fields flow; no separate card or section header)
					...
					if ( ! empty( $active_custom_fields ) ) :
						...
						foreach ( $active_custom_fields as $cf ) {
							if ( in_array( $cf->field_type, array( 'textarea', 'multiselect' ), true ) ) {
								if ( ! empty( $current_row ) ) {
									$field_chunks[] = $current_row;
									$current_row    = array();
								}
								$field_chunks[] = array( $cf );
							} else {
								$current_row[] = $cf;
					...
					?>
						<div class="nds-hr-fields-row">
							...
							?>
								<div class="nds-hr-field-group" style="<?php echo in_array( $field_type, array( 'textarea', 'multiselect' ), true ) ? 'flex: 1 1 100%;' : ''; ?>">
